module.exports = Base => class extends Base {
    ...
    cooldownStart(command, playerName, time, args) {
        if (!this.onCooldownMap[playerName]) this.onCooldownMap[playerName] = {}
...
//this all works perfectly with the home command. i'll need to change some things so it can be compatable with warp. i should look at how i check for args for example.